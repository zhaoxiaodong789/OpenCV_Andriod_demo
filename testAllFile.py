...
if __name__ == '__main__':
    ...
    #     path = local + '05102009'+str(i)+'.jpg'
    #     path_txt = path + '.txt'
    #
    #     if os.path.exists(path) and os.path.exists(path_txt):
    #
    #         sum = sum + 1
    #         barCode = barcode_detection(path)
    #
    #         barCode_string = ""
    #         for item in barCode:
    ...
    #         file.close()
    #
    #         if barCode_string == file_data_string:
    #             success = success + 1
    #
    #         print(barCode_string == file_data_string)
    #         print('----------')
    #
    # print(success)
    # print(float(success / sum))

    # 今天读取1张代码，没出现数组越界 2020.4.5
    # img = cv2.imread("median03.png")
    #
    # img2 = img
    # # img2 = rotate(img, 45)
    #
    ...
    #
    # barCode = barcode_detection("1.png")


    # barCode = barcode_detection("D:/ean13/BarcodeImage/5.png")
    # excelBarcode = pd.read_excel("ean13.xlsx", header = None)
    # barCode_string = ""
    # for item in barCode:
    #     barCode_string = barCode_string + str(item)
    #
    # excelBarcode_string = str(excelBarcode.iloc[0, 0])
    # print(barCode_string == excelBarcode.iloc[0, 0])
    # print(type(barCode_string))
    # print(type(excelBarcode.iloc[0, 0]))
    # print(type(excelBarcode_string))
    #
    # print(barCode_string == excelBarcode_string)
    # print(barCode_string)
