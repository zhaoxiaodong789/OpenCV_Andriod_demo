...
def barcode_detection(image):
    ...
    cv2.imshow("xuanzhuan", xuanzhuanImg_cut)
    ...
    grayImg2 = ostu(grayImg)
    cv2.imshow("sb", grayImg2)

    # 图像增强

    grayImg = cv2.equalizeHist(grayImg)
    cv2.imshow("zengqiang", grayImg)

    grayImg = ostu(grayImg)

    cv2.imshow("ostu", grayImg)
...
if __name__ == '__main__':
    ...
    path = "C://Users//xiaodong//Desktop//biyesheji//BarcodeDatasets//Dataset2"
    imgName = "Foto(676).jpg"
    # path = "D:/ean13/BarcodeImage_hough"
    # imgName = "111.png"
